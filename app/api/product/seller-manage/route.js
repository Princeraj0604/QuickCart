...
export async function PUT(request) {
  try {
    ...
    console.log("SELLER MANAGE USER ID:", userId);
    console.log("SELLER MANAGE IS SELLER:", isSeller);
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "Required product details and at least one product image are needed",
        },
        { status: 400 },
      );
    }
    ...
    product.ingredients = Array.isArray(ingredients) ? ingredients : [];

    product.allergens = Array.isArray(allergens) ? allergens : [];
