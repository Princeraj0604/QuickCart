...
const EditProduct = () => {
  ...
  const fetchProduct = async () => {
    try {
      ...
      const foundProduct = data.products.find((item) => item._id === params.id);
      ...
      setFormData({
        ...
        storageInstructions: foundProduct.storageInstructions || "",
        ingredients: foundProduct.ingredients?.join(", ") || "",
        allergens: foundProduct.allergens?.join(", ") || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put("/api/product/seller-manage", payload, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-[#2F241D] mb-3">
                  Product Images
                </label>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {formData.images.map((image, index) => (
                    <div
                      key={`${image}-${index}`}
                      className="relative aspect-square rounded-xl overflow-hidden border border-[#E9DFD0] bg-[#F4EFE6]"
                    >
                      <Image
                        src={image}
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-8 h-8 rounded-full bg-white/95 text-red-600 text-lg font-medium shadow-sm hover:bg-red-50 transition"
                      >
                        ×
                      </button>
                    </div>
                ...
                <div className="mt-5">
                  ...
                  <input
                    ...
                    className="block w-full text-sm text-[#66574D]
                        file:mr-4 file:rounded-full file:border-0
                          file:bg-[#F4EFE6] file:px-4 file:py-2
                        file:text-sm file:font-medium file:text-[#6B3F24]
                         hover:file:bg-[#E9DFD0]"
                  />
                  ...
                  <p className="mt-2 text-xs text-[#66574D]">
                    Maximum 4 images. JPG, PNG or WEBP. Up to 5MB per image.
                  </p>
                </div>
            ...
            <div className="mt-8 border-t border-[#E9DFD0] pt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <label className="flex items-center gap-3 rounded-xl border border-[#E9DFD0] px-4 py-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#66574D]">Featured</span>
                </label>
                ...
                <label className="flex items-center gap-3 rounded-xl border border-[#E9DFD0] px-4 py-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#66574D]">Best Seller</span>
                </label>
                ...
                <label className="flex items-center gap-3 rounded-xl border border-[#E9DFD0] px-4 py-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#66574D]">New Arrival</span>
                </label>
                ...
                <label className="flex items-center gap-3 rounded-xl border border-[#E9DFD0] px-4 py-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#66574D]">Active Product</span>
                </label>
              </div>
            </div>
